      ...
      <nav className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          <Link to="/" className="flex items-center gap-2">
            <img
              src="https://res.cloudinary.com/gidasta/image/upload/f_auto,fl_lossy,h_32,w_32,q_auto/v1749081955/images/call-center/static/520d8ba8-17f4-4293-a58e-2783bd05931c.png"
