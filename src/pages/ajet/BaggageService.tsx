      ...
      <div className="container py-8 space-y-12">
        ...
        <div className="text-center space-y-4">
          ...
          <h1 className="text-4xl font-bold mb-4 flex items-center justify-center gap-2">
            <Luggage className="h-10 w-10 text-ajet" />
            AJet Bagaj Hizmeti
          </h1>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            AJet uçuşlarınız için bagaj hizmetlerimizden faydalanın. 
        ...
        <div className="relative h-[400px] rounded-xl overflow-hidden">
          <img
            ...
            alt="AJet Bagaj Hizmeti"
            className="w-full h-full object-cover"
          />
          <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex items-end">
            <div className="p-8 text-white">
              <h2 className="text-3xl font-bold mb-2">AJet Bagaj Hizmetleri</h2>
          ...
          <Card className="hover:shadow-lg transition-shadow">
            ...
            <CardContent>
              <p className="text-gray-600">
                AJet bagaj işlemleriniz güvenli bir şekilde gerçekleştirilir. 
        ...
        <div className="prose prose-lg max-w-none">
          <h2 className="text-3xl font-bold mb-6">AJet Bagaj Hizmetleri</h2>
          
          <div className="grid md:grid-cols-2 gap-8 mb-8">
            <img
              src="/lovable-uploads/04790e9a-9300-402d-92ec-824ca1c5a0db.png"
              alt="AJet Bagaj İşlemleri"
              className="rounded-lg h-[300px] w-full object-cover"
            />
            <div className="space-y-4">
              <h3 className="text-2xl font-semibold">Profesyonel AJet Bagaj Hizmeti</h3>
              <p>
                AJet bagaj hizmetlerinizi en uygun şartlarda ve hızlı bir şekilde 
          ...
          <div className="bg-primary/5 p-8 rounded-lg mb-8">
            <h3 className="text-2xl font-semibold mb-4">AJet Bagaj Hizmetleri Avantajları</h3>
...
export default AjetBaggageService;
