      ...
      <div className="container py-12 md:py-16 space-y-16 mb-16">
        <div className="text-center space-y-4">
          ...
          <h1 className="text-4xl font-bold mb-4 flex items-center justify-center gap-2">
            <ArrowUpCircle className="h-10 w-10 text-pegasus" />
            Pegasus Sınıf Yükseltme
          </h1>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Pegasus ile seyahat deneyiminizi daha konforlu hale getirmek için 
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <ul className="space-y-4">
              {classUpgradeContent.features.map((feature, index) => (
                <li key={index} className="flex items-center gap-2">
                  <BadgeCheck className="h-5 w-5 text-pegasus" />
                  <span>{feature}</span>
                </li>
              ))}
            </ul>
          ...
          <div className="space-y-6">
            <Card className="hover:shadow-lg transition-shadow">
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  <Star className="h-6 w-6 text-pegasus" />
                  BolBol Avantajları
                </CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600">
                  BolBol üyeleri, puanlarını kullanarak sınıf yükseltme yapabilir 
...
export default PegasusClassUpgrade;