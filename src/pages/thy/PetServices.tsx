      ...
      <div className="container py-12 md:py-16 space-y-16 mb-16">
        ...
        <div className="text-center space-y-4">
          ...
          <h1 className="text-4xl font-bold mb-4 flex items-center justify-center gap-2">
            <PawPrint className="h-10 w-10 text-thy" />
            Türk Hava Yolları Evcil Hayvan Taşıma
          </h1>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Türk Hava Yolları ile sevgili dostlarınızın güvenli ve konforlu seyahati için özel çözümler sunuyoruz. 
