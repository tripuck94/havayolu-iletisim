export const ticketPurchaseContent = {
  ...
  mainImage: "https://res.cloudinary.com/gidasta/image/upload/f_auto,fl_lossy,q_auto,w_800,h_400,c_fill/images/call-center/static/public/lovable-uploads/fcf6d3d4-46ef-4c5e-8a48-a2e4159997a5.jpg",
  advantages: [
    {
      icon: "Shield",
  ...
  features: [
    ...
    "Tüm havayolları için tek noktadan hizmet",
    "Hızlı ve kolay rezervasyon"
  ],
  callToAction: {
    title: "Hemen Biletinizi Alın",
    description: "Size en uygun uçuş biletini bulmak için çağrı merkezimizi arayın."
  }
};
