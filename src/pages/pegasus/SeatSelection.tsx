  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-20 md:pb-0">
      ...
      <div className="container py-8 space-y-12">
        ...
        <div className="text-center space-y-4">
          ...
          <h1 className="text-4xl font-bold mb-4 flex items-center justify-center gap-2">
            <Armchair className="h-10 w-10 text-pegasus" />
            Pegasus Koltuk Seçimi
          </h1>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Pegasus uçuşunuz için koltuğunuzu önceden seçin ve rahat bir yolculuk deneyimi yaşayın.
          </p>
        </div>
        ...
        <div className="relative h-[400px] rounded-xl overflow-hidden">
          <img
            ...
            alt="Pegasus Koltuk Seçimi"
            className="w-full h-full object-cover"
          />
          <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex items-end">
            <div className="p-8 text-white">
              <h2 className="text-3xl font-bold mb-2">Pegasus Koltuk Seçimi</h2>
          ...
          <Card className="hover:shadow-lg transition-shadow">
            ...
            <CardContent>
              <p className="text-gray-600">
                Pegasus koltuk seçimi işlemleriniz güvenli bir şekilde gerçekleştirilir. 
        ...
        <div className="prose prose-lg max-w-none">
          <h2 className="text-3xl font-bold mb-6">Pegasus Koltuk Seçimi Hizmetlerimiz</h2>
          
          <div className="grid md:grid-cols-2 gap-8 mb-8">
            <img
              src="/lovable-uploads/5bc51257-584d-4039-b174-07ba6c2b1766.png"
              alt="Pegasus Koltuk Seçimi İşlemleri"
              className="rounded-lg h-[300px] w-full object-cover"
            />
            <div className="space-y-4">
              <h3 className="text-2xl font-semibold">Profesyonel Pegasus Koltuk Seçimi Hizmeti</h3>
              <p>
                Pegasus koltuk seçimi işlemlerinizi en uygun şartlarda ve hızlı bir şekilde 
          ...
          <div className="bg-primary/5 p-8 rounded-lg mb-8">
            <h3 className="text-2xl font-semibold mb-4">Pegasus Koltuk Seçimi Avantajları</h3>
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 p-4 bg-white border-t shadow-lg">
        <Button onClick={handleCall} className="w-full bg-pegasus hover:bg-pegasus-hover text-white text-xl py-6">
...
export default PegasusSeatSelection;
