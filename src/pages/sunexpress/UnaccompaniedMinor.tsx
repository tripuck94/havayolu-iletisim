...
const SunExpressUnaccompaniedMinor = () => {
  const handleCall = () => {
      ...
      <div className="container py-12 md:py-16 space-y-16 mb-16">
        ...
        <div className="text-center space-y-4">
          ...
          <h1 className="text-4xl font-bold mb-4 flex items-center justify-center gap-2">
            <Users className="h-10 w-10 text-sunexpress" />
            SunExpress Refakatsiz Çocuk Hizmeti
          </h1>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            SunExpress ile çocuğunuzun güvenli ve konforlu seyahati için özel refakat hizmetimiz ile
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <ul className="space-y-4">
              {unaccompaniedMinorContent.features.map((feature, index) => (
                <li key={index} className="flex items-center gap-2">
                  <CheckCircle2 className="h-5 w-5 text-sunexpress" />
                  <span>{feature}</span>
                </li>
              ))}
            </ul>
          ...
          <div className="space-y-6">
            <Card className="hover:shadow-lg transition-shadow">
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  <Plane className="h-6 w-6 text-sunexpress" />
                  Seyahat Süreci
                </CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card className="hover:shadow-lg transition-shadow">
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  <UserCheck className="h-6 w-6 text-sunexpress" />
                  Deneyimli Personel
                </CardTitle>
              </CardHeader>
              <CardContent>
...
export default SunExpressUnaccompaniedMinor;