...
export const airlines: Record<string, AirlineData> = {
  thy: {
    ...
    shortName: "THY",
    logo: "https://res.cloudinary.com/gidasta/image/upload/f_auto,fl_lossy,h_80,w_80,q_auto/images/airline/small/TK.webp",
    primaryColor: "thy",
    hoverColor: "thy-dark",
    bgColor: "bg-thy",
    textColor: "text-thy",
  ...
  sunexpress: {
    ...
    name: "SunExpress",
    shortName: "SXS",
    logo: "https://res.cloudinary.com/gidasta/image/upload/f_auto,fl_lossy,h_80,w_80,q_auto/images/airline/small/XQ.webp",
  ...
  pegasus: {
    ...
    shortName: "Pegasus",
    logo: "https://res.cloudinary.com/gidasta/image/upload/f_auto,fl_lossy,h_80,w_80,q_auto/images/airline/small/PC.webp",
  ...
  ajet: {
    ...
    name: "AJet",
    shortName: "AJet",
    logo: "https://res.cloudinary.com/gidasta/image/upload/f_auto,fl_lossy,h_80,w_80,q_auto/images/airline/small/VF.webp",
    primaryColor: "ajet",
  ...
  azal: {
    ...
    name: "AZAL",
    shortName: "AZAL",
    logo: "https://res.cloudinary.com/gidasta/image/upload/f_auto,fl_lossy,h_80,w_80,q_auto/images/airline/small/J2.webp",
    primaryColor: "azal",
